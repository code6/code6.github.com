...
* *markdown*
可以使用惯用的markdown来写文章(比如我觉得 "textile":http://redcloth.org/textile 跟 "confluence":http://www.atlassian.com/software/confluence/overview的编辑语法很像)
* *git && githhub*
...
到这一步基本在本机上已经安装好ctopress了, 我们可以把它发布到Github上(当然你还可以部署到 "其他地方":http://octopress.org/docs/deploying/ )。首先你得建一个以用户名命名的类似 @username.github.com@ 的Repository。比如我的就是 @code6.github.com@, 然后设定Github Pages:
